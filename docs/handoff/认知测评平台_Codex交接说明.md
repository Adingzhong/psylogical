...
3. 如需判断材料是否够审核，读 docs/handoff/审核材料充分性检查.md
4. 如需深挖，再读 docs/handoff/认知测评平台_修改记录与交接说明.md
...
| `4月18日 修改/文献原文/` | 已上传的关键 PDF 和提取文本 |
| `UX图片/` | 指导语、语音脚本、界面图片、适老化 UX 方案 |
| `按钮修正/` | 触控按钮、适老化交互相关依据 |
| `docs/handoff/material_previews/` | N-back、VSTMB、语音材料压缩预览 |
| `docs/handoff/当前上传材料清单.csv` | 当前上传材料索引，适合机器检索 |
